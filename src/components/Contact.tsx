    ...
    <div className="flex flex-col xl:flex-row cut-border">
      <form className="flex flex-col items-center gap-2 p-2 pb-5 xl:w-1/2 bg-[#ffffff] dark:bg-darkGray max-xl:border-b-2 xl:border-r-2 border-darkerRed dark:border-lighterRed">
        ...
        <div className="w-[80%]">
          <button
            type="submit"
            className="flex gap-3 items-center mt-5 ml-auto px-2 border-l-4 hover:scale-105 hover:-translate-y-[4%] hover:border-darkerRed dark:hover:border-lighterRed ease duration-100"
      ...
      <div className="flex flex-col items-center gap-3 px-4 pt-2 pb-5 xl:w-1/2 bg-[#ffffff] dark:bg-darkGray max-xl:border-t-2 xl:border-l-2 border-darkerRed dark:border-lighterRed truncate">
        ...
        <ul className="flex flex-col xl:justify-evenly gap-5 h-3/5 w-full text-sm font-normal">
          ...
          <li className="group flex items-center gap-2">
            ...
            <a
              ...
              target="_blank"
            >
              https://instagram.com/stefan.dragicevic_?igshid=MmVlMjlkMTBhMg==
            </a>
          </li>
        </ul>
      </div>
